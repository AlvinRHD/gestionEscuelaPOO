...
namespace gestionEscuela.Director
{
    public class DirectorC : Usuarios
    {
        private List<string> alumnos;
        private List<string> profesores;

        public DirectorC(string email, string contraseña) : base(email, contraseña, TipoUsuario.Director)
        {
